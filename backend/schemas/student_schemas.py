...
class StudentRegister(BaseModel):
    ...
    '''
    identification_number: int = Field(..., title='Número de Identificación', description='Número único del estudiante')
    names: str = Field(...,min_length=2, max_length=50, title='Nombres', description='Nombres del estudiante')
    last_names: str = Field(...,min_length=2, max_length=50, title='Apellidos', description='Apellidos del estudiante')
    email: EmailStr = Field(..., title='Correo Electrónico', description='Correo electrónico válido del estudiante')
    password: str = Field(...,min_length=6, title='Contraseña', description='Contraseña con mínimo 6 caracteres')
