...
class IdentificationCodeCheck(BaseModel):
    ...
    identification_code: int = Field(
        ...,
        description="Código de identificación a verificar.",
        ge=1000000000,
        le=9999999999,  # Valor debe ser de 10 digitos
...
class RegistrationResponse(BaseModel):
    ...
    identification_id: Optional[int] = (
        None  # Cambio para envio de numero de identificacion
    )
