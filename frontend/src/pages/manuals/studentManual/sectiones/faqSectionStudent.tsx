...
export const faqSectionStudent=()=>{
    return(
        <div className="faq-Section-Student-Container">
            ...
            <h3 className="faq-subtitle">¿Olvidé mi contraseña, qué hago?</h3>
            ...
            <h3 className="faq-subtitle">¿No puedo ver una lección?</h3>
            <p className="paragraph">Verifica tu conexión a internet. Si el problema persiste, comunícate con soporte técnico.</p>
            <h3 className="faq-subtitle">Me gustaria un efecto visual en una pagina del aplicativo</h3>
            <p className="paragraph">En el formulario quejas y sugerencias puedes dejarnos tu inquietud</p>
