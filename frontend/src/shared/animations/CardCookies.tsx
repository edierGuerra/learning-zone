      ...
      {clickMoreOptions ? (
        <div className="card-options">
          ...
          <p className="options-description">
            Selecciona qué tipos de cookies deseas permitir. Puedes cambiar
          ...
          <div className="options-actions">
            ...
            <button
              ...
              type="button"
              onClick={() => setClickMoreOptions(false)}
            >
              Cancelar
            </button>
          </div>
        ...
        <div className="card-privacy">
          ...
          <div className="card-center">
            ...
            <p className="card-text-cookie">
              ...
              <a
                className="card-link"
                onClick={() => handleBtnNavigate("/sitePolicies")}
              >
                Privacy Policy
              </a>
              .
          ...
          <div className="card-right">
            <button
              ...
              onClick={() => setClickMoreOptions(true)}
            >
              More Options
            </button>
            <button
